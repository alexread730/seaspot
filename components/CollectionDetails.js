...
export default function CollectionDetails(props) {
  ...
  return (
      <div 
        className="block grid md:grid-cols-1 md:grid-cols-6 gap-4 bg-blue-500 bg-opacity-40 border-2 rounded-xl border-blue-900 shadow-lg py-6 px-8 text-center"
