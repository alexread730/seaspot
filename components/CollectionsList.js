...
export default function CollectionsList() {
  ...
  if (!data) {
    content = <div className="animate-spin rounded-full border-4 border-dotted border-blue-500 h-24 w-24"></div>
  } else {
  ...
  // render data
  return <div className="grid grid-cols-4 gap-8 container mx-auto mt-20">{content}</div>;
}
