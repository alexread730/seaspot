  ...
  return (
    <div className="grid w-full md:w-1/5 mx-auto px-6">
      <AddressContext.Consumer>
        {({numOne, numTwo}) => (
          <button className="mt-16 py-5 px-8 bg-blue-800 border-2 border-black shadow-sm rounded-md text-white font-bold" onClick={isMobile ?  openDeepLink : addressContext.getEthAddress}>
